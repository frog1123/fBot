...
module.exports = {
    ...
    execute(message, args, Discord, client, bot) {
        ...
        if (typeof user === 'undefined') message.channel.send({ embeds: [new Discord.MessageEmbed().setColor(config.bots[bot].color).setTitle('You must provide a user to DM')]});
            ...
            if (typeof user !== 'undefined' && user.id === item) message.channel.send({ embeds: [new Discord.MessageEmbed().setColor(config.bots[bot].color).setTitle('You cannot DM this user')]});
        }));
